...
RL_data_path = data_path + time.strftime("RL_MODEL_%d_%m_%Y___%H_%M_%S/")
...
qrl = QRL(num_neurons = num_neurons, 
...
training_graphs = generate_ER_graphs(num_samples = training_size, size_range = [8,8], p_edge = 0.4)
training_graphs.extend(generate_ER_graphs(num_samples = training_size, size_range = [8,8], p_edge = 0.5))
training_graphs.extend(generate_ER_graphs(num_samples = training_size, size_range = [8,8], p_edge = 0.7))
